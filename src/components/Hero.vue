...
<template>
  <div class="relative isolate px-6 pt-7 lg:px-8 bg-white dark:bg-dark ">
...
-->
      ...
      <div class="text-center">
        <h1 class="text-4xl font-bold tracking-tight text-dark dark:text-white sm:text-6xl">Data to enrich your online
          business</h1>
        <p class="mt-6 text-lg leading-8 text-dark dark:text-white">Anim aute id magna aliqua ad ad non deserunt sunt.
